        ...
        <>
            <div className="bg-white center h-full w-1/2  rounded_border text-black rb">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="">
                                    ...
                                    <Input className="input_css" placeholder="Your Name" {...field} />
                                    <FormMessage className="text-red-600" />
                                </FormItem>
                            )}
                        />
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input className="input_css" placeholder="Your email address" {...field} />
                                    </FormControl>
                                    <FormMessage className="text-red-600" />
                                </FormItem>
                            )}
                ...
                <div className="flex text-style">
                    ...
                    <Link to={'/si-in'}>
                    <div className="text-style text-p-1">Log In</div>
                    </Link>
